		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax_productos"></div>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-8">
				  <input type="text" class="form-control" id="precio" name="precio" placeholder="Precio de venta del producto"  title="Ingresa sólo números con 0 ó 2 decimales" maxlength="12"> <!--required pattern="^[0-9]{1,5}(\.[0-9]{0,2})?$"-->
				</div>
			  </div>
