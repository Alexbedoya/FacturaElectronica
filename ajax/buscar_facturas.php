			  ...
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<td class="text-right">
						...
						<a href="#" class='btn btn-default' title='Enviar factura por email' onclick="enviar_email('<?php echo $id_factura;?>', '<?php echo $email_cliente; ?>');"><i class="glyphicon glyphicon glyphicon-envelope"></i></a>
						<a href="#" class='btn btn-default' title='Enviar whatsapp' onclick="enviar_whatsapp('<?php echo $telefono_cliente;?>' , '<?php echo MENSAJE_WHATSAPP;?>');"><i class=""><span><img style="width: 15px; height: 15px; margin-bottom: 3px" src="img/icon-whatsapp.png"></span></i></a> 
